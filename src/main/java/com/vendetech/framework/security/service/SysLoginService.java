...
public class SysLoginService {
    ...
    public String login(String username, String password, String code, String uuid) {
        ...
        if (count == 6) {
            if (captcha == null) {
                AsyncManager.me().execute(AsyncFactory.recordSysLoginInfo(username,
        ...
        try {
            ...
            if (e instanceof BadCredentialsException) {
                AsyncManager.me().execute(AsyncFactory.recordSysLoginInfo(username, Constants.LOGIN_FAIL,
                ...
                AsyncManager.me().execute(AsyncFactory.recordSysLoginInfo(username, Constants.LOGIN_FAIL, e.getMessage()));
