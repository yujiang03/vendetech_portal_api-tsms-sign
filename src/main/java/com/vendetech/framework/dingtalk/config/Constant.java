package com.vendetech.framework.dingtalk.config;
...
public class Constant {
	...
	public static final String TIMESHEET_NOTIFICATION = "请及时对下属员工分配当月的项目。如果错过当月分配时段，需提交补充分配审批电子流由事业部主管审批，通过后由系统管理员补充分配。谢谢！";
