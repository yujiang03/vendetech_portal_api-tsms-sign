...
import com.vendetech.controller.SysUserController;
...
public class ExcelUtils {
	...
	public static List<String[]> getExcelData(MultipartFile file) throws IOException, InvalidFormatException {
		...
		if (workbook != null) {
			for (int sheetNum = 0; sheetNum < workbook.getNumberOfSheets(); sheetNum++) {
				...
				// 循环除了第一行的所有行
                loopCells(list, sheet, firstRowNum, lastRowNum);
            }
		}
		return list;
	}
    ...
    private static void loopCells(List<String[]> list, Sheet sheet, int firstRowNum, int lastRowNum) {
